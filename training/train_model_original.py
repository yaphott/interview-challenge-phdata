...
def main() -> None:
    ...
    features_path = (
        PROJECT_DIR
        / "models"
        / f"original_{start_dt.strftime('%Y-%m-%d_%H-%M-%S')}_model_features.json"
    )
    ...
    metadata_path = (
        PROJECT_DIR
        / "models"
        / f"original_{start_dt.strftime('%Y-%m-%d_%H-%M-%S')}_model_metadata.json"
    )
    ...
    model_path = (
        PROJECT_DIR
        / "models"
        / f"original_{start_dt.strftime('%Y-%m-%d_%H-%M-%S')}_model.pkl"
    )
